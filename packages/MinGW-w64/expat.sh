...
function pkg_download() {
    ...
    local PKG_SIG_FILENAME="${PKG_IDENTIFIER}.tar.xz.asc"
    local PKG_SRC_URL="https://sourceforge.net/projects/expat/files/expat/${PKG_VERSION}/${PKG_SRC_FILENAME}"
    local PKG_SIG_URL="https://sourceforge.net/projects/expat/files/expat/${PKG_VERSION}/${PKG_SIG_FILENAME}"
    ...
    func_verify gpg \
        ${SCRIPT_KEYRINGS_PATH}/expat-keyring.gpg \
